        ...
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-gray-300 rounded-3xl xl:min-h-100 group'>
                    ...
                    <Image className='sm:absolute bottom-0 right-0 md:right-10 w-full sm:max-w-sm' src={assets.hero_model_img} alt="" href='/shop' />
                </div>
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-gray-200 rounded-3xl p-6 px-8 group'>
                        ...
                        <Image className='w-35' src={assets.hero_product_img1} alt="" href='/shop' />
                    </div>
                    <div className='flex-1 flex items-center justify-between w-full bg-gray-400 rounded-3xl p-6 px-8 group'>
                        ...
                        <Image className='w-35' src={assets.hero_product_img2} alt="" href='/shop' />
                    </div>
                </div>
            </div>
            <CategoriesMarquee />
